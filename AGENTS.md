...
- меняет статусы задач, пишет review-заключения и архивирует `task.md` / `review.md` в `changelog.md`
...
- не меняет `doc/*`, не архивирует задачи и не пишет review-заключения; если документация устарела, сообщает об этом в итоговом отчёте
...
- При архивировании architect переносит соответствующие заключения в `changelog.md`
...
- После любого значимого изменения architect обновляет `doc/*`; worker документацию не меняет
